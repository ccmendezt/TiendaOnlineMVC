...
(22, 'iPhone 11 Pro Max', 'http://localhost:80/carrito/iphone 11.jpg', 'iOS 13 Capacidad 128GB Chip A9 con arquitectura de 64 bits Coprocesador de movimiento M9 integrado Camara Dual de 24 Mpx', 1600, 1000),
(23, 'AirPods - Apple', 'http://localhost:80/carrito/airpods.jpg', 'Los AirPods ahora te ofrecen una duracion inigualable de 5 horas de audio y hasta 3 horas para hablar con una sola carga', 150, 100),
(24, 'iPad  Pro - Apple', 'http://localhost:80/carrito/Ipad.png', 'Face ID\nEl A12X Bionic es el chip mas inteligente y potente que hemos creado hasta ahora. Capacidad de 256GB Pantalla 4K ', 2400, 1000),
(25, 'Apple - Pencil', 'http://localhost:80/carrito/applepencil.png', 'El Apple Pencil reinventada la forma de dibujar, tomar notas y marcar documentos para hacerla mÃ¡s intuitiva, precisa y mÃ¡gica.', 200, 1000),
(26, 'MacBook Air', 'http://localhost:80/carrito/macbookair.jpg', 'Pantalla de retina de alta resolucion 2560 x 1600 La MacBook Air ahora trae Touch ID Capacidad de 1TB SSD Memoria RAM de 16GB DDR4 Intel Core i7 de Septima generacion.', 4500, 1000),
(28, 'MacBook Pro', 'http://localhost:80/carrito/macpro.jpg', 'Pantalla de retina de alta resolucion 2560 x 1600 La MacBook Pro ahora trae Touch ID Capacidad de 2TB SSD Memoria RAM de 32GB DDR4 Intel Core i9 de novena generacion.', 16200, 1000),
(29, 'TV - Apple', 'http://localhost:80/carrito/tv.jpg', 'Una forma de ver television como siempre sonaste: tus servicios de streaming favoritos, miles de titulos para comprar o alquilar, e historias originales de Apple TV+ ', 1500, 5000),
(30, 'Apple Watch Series 3', 'http://localhost:80/carrito/relok.png', 'Monitorea tu salud, Los calculos Pararse, Moverse y Ejercicio te muestran todos los movimientos que haces diariamente. Nunca te pierdas una llamada o notificacion importante, llamada automaticas', 450, 1200),
(31, 'iMac Pro - Apple', 'http://localhost:80/carrito/imac.jpg', 'Procesador Xeon de\n8, 10, 14 o 18 nucleos\nTurbo Boost de hasta 4.5 GHz\nHasta 42 MB de cache. Gracias al GPU Radeon Pro Vega, la iMac Pro ofrece los graficos mÃ¡s espectaculares de todas las Mac', 5600, 100),
(32, 'Home Pod - Apple', 'http://localhost:80/carrito/home.jpg', 'Dimensiones:\n17,2 cm de alto\n14,2 cm de ancho\n\nPeso:\n2,5 kg\n\nColor:\nGris espacial\nBlanco\nWiFi 802.11ac con MIMO\nAcceso directo para invitados\nBluetooth 5.0\nAdmite altavoces en varias habitaciones con AirPlay ', 500, 200),
(33, 'iPhone 11 Pro max', 'http://localhost:80/carrito/iphone11.jfif', 'iOS 13 Capacidad 128GB Chip A12 con arquitectura de 64 bits Coprocesador de movimiento M9 integrado Camara de 48 Mpx', 5000, 100);
